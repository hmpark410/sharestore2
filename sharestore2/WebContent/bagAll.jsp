	...
	<div id="page">
		...
		<section id="pdtlist_block">
			...
			<div class="sub_category">
				<span>> <a href="bagAllSub.do?subCategory=8">숄더백</a></span>
				<span>> <a href="bagAllSub.do?subCategory=9">토트백</a></span>
				<span>> <a href="bagAllSub.do?subCategory=10">클러치</a></span>
				<span>> <a href="bagAllSub.do?subCategory=11">백팩</a></span>
				<span>> <a href="bagAllSub.do?subCategory=12">지갑/파우치</a></span>
				<span>> <a href="bagAllSub.do?subCategory=13">기타</a></span>
			</div>
			<ul>
				<%
