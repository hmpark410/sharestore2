        ...
        <div class="pupdate_frame">
        	<div class="pupdate_cont">
				<form action="adminPrdUpdate.do" method="post">
					...
					<% 
						for(int i = 0; i < adminPrdUpdatelist.size(); i++){
							ProductVO prdlist = adminPrdUpdatelist.get(i);	
					%>
					<table>
						<tbody>
							<tr>
				        		<th>셀러 ID</th>
				        		<td>
						            <input type="text" name="sellerId" id="sellerId" value = "<%=prdlist.getSellerId() %>" maxlength="50" readonly></p>
				        		</td>
				       		</tr>
				        	<tr>
				        		<th>상품 ID</th>
