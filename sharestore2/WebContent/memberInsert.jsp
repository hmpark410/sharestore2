	        ...
	        <div class="member_frame">
	        	<div class="member_cont">
					...
					<table>
						<tbody>
				        	<tr>
				        		...
				        		<td>
				        			<p class="email va_m">
						            <input type="text" name="id" id="id" maxlength="50" style="ime-mode:disabled"></p>
				        		</td>
				       		</tr>
					        <tr>
							...
							<tr>
						        ...
						        <td>
						        	<p class="join_name va_m">
                       				<input type="text" name="name" id="name" maxlength="10" placeholder="ex) 홍길동" /></p>
						        </td>
							</tr>
							<tr>
						    	<th>휴대폰번호<span>*</span></th>
						        <td>
					          		<input type="text" name="phone" id="phone" maxlength="11" placeholder="하이픈(-)을 제외하고 입력해주세요.">
					          	</td>
							</tr>
							<tr>
						    	<th>주소</th>
						        <td>
					          		<input type="text" name="address" id="address" maxlength="45" placeholder="상세 주소를 입력해주세요.">
					          	</td>
							</tr>
							<tr>
						    	<th>이메일</th>
						        <td>
					          		<input type="text" name="mail" id="mail" maxlength="30" placeholder="@을 포함하여 입력해주세요.">
					          	</td>
							</tr>
							<tr>
						    	<th>성별<span>*</span></th>
						        ...
						        <td>
				               		<div class="select_box_wrap">
				                        <div class="select_box birth_box">
					                        <select id="birth" name="select_year" style="width: 124px;" class="normal">
					                        ...
					                        <select id="select_month" name="select_month" style="width: 124px;" class="normal">
											...
											<select id="select_day" name="select_day" style="width: 124px;" class="normal">
					...
					<div class="join_btn_wrap">
		                ...
		                <button type="submit" id="btnConfirm" name="button" class="btn black" onclick="javascript: form.action='memberInsert.do';">확인</button>   
		            </div>
				</div>
		   	</div> 
		</section>
