		...
		<section id="container">
			...
			<div class="member_frame">
		       	<div class="member_cont">
		       		<div class="mymember">
					    <div class="info">
					        <h3><strong>${member.name}</strong>님 안녕하세요 :)</h3>
					        <a href="#" class="member_update" onclick="showPopup();" >정보관리</a>
					        <script type="text/javascript">
								function showPopup() { window.open("memberUpdate.jsp", "정보관리", "width=850, height=900, top=45, left=535"); }
							</script>
					    ...
					    <ul>
					        <li>
					            <a>
					                ...
					                <%=sum %></span> 원 ( <span><%=orderList.size() %></span> 회)</p>
					                <% } else { %>
					                0</span> 원 ( <span>0</span> 회)</p>
					                <%} %>
					            </a>
					        </li>
					    </ul>
					...
					<form name="form1" method="post">
						...
						<table class="cols tbl_product shopping">
							...
							<%} 
								...
								<tr>
									<th colspan="5" style="text-align:center;"><p>구매 내역이 없습니다.<p></th>
								 </tr>
							 <%}%>
							</tbody>		
						</table>
