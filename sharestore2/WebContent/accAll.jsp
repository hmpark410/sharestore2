	...
	<div id="page">
		...
		<section id="pdtlist_block">
			...
			<div class="sub_category">
				<span>> <a href="accAllSub.do?subCategory=21">주얼리</a></span>
				<span>> <a href="accAllSub.do?subCategory=22">모자</a></span>
				<span>> <a href="accAllSub.do?subCategory=23">시계</a></span>
				<span>> <a href="accAllSub.do?subCategory=24">스카프/머플러</a></span>
				<span>> <a href="accAllSub.do?subCategory=25">안경</a></span>
				<span>> <a href="accAllSub.do?subCategory=26">선글라스</a></span>
				<span>> <a href="accAllSub.do?subCategory=27">기타</a></span>
			</div>
			<ul>
				<%
