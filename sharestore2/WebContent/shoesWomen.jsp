...
<body>
	<div id="page">
		...
		<section id="pdtlist_block">
			<h1>HOME > SHOES > WOMEN</h1>
			<div class="sub_category">
				<span>> <a href="subCategory.do?category=1003&subCategory=14">펌프스</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=15">플랫/로퍼</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=16">슬리퍼/뮬</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=17">샌들</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=18">부츠</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=19">스니커즈</a></span>
				<span>> <a href="subCategory.do?category=1003&subCategory=20">기타</a></span>
			</div>
			<ul>
				<%
